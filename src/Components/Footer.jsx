  ...
  return (
    <footer>
      <div className={styles.footerWrapper}>
        ...
        <div className={`navbar-light bg-${theme} ${styles.footer}`}>
          <div className="container">
            <div className={`row`}>
              <div className="col-sm-12 col-lg-6">
                ...
                <img
                  className={`${styles.dhLogo} ${theme === 'dark' ? styles.dhLogoDark : ''}`}
                  src="/images/DH.png" alt='DH-logo' />
              </div>
              <div
                className={`col-sm-12 col-lg-6 
                ${styles.icons} ${theme === 'dark' ? styles.iconsDark : ''}`}>
